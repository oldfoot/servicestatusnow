...
class pricing {
	...
	public function HTML() {
		...
		$table .= "<br /><br /><table width:100%>\n";
			...
			$table .= "<td colspan='3'><hr></td>\n";
			$sql = "CALL sp_core_pricing()";
			$result = $GLOBALS['db']->Query($sql);
			$count = 0;
			while ($row = $GLOBALS['db']->FetchArray($result)) {	
				if ($count == 0) {				
				...
				$table .= "<th width=15% scope='col' id='vzebra-comedy'>Monthly <br />".PayPalPay(49,12,"M")."</th>\n";
				$table .= "</tr></thead>\n";
				$table .= "<thead><tr style='font-size:large'>\n";
				$table .= "<th width=40% scope='col' id='vzebra-comedy'></th>\n";
				$table .= "<th width=15% scope='col' id='vzebra-comedy'></th>\n";			
				$table .= "<th width=15% scope='col' id='vzebra-comedy'>Yearly <br />".PayPalPay(429,1,"Y")."</th>\n";
				$table .= "</tr></thead>\n";
				$table .= "<td colspan='3'><hr></td>\n";
			$table .= "</table>\n";
